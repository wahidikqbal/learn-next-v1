    ...
    webServer: useExternalServer
        ...
        : {
            ...
            env: {
                ...
                LARAVEL_API_BASE_URL: process.env.LARAVEL_API_BASE_URL ?? 'http://127.0.0.1:8000/api',
                ENABLE_LARAVEL_PHASE2: process.env.ENABLE_LARAVEL_PHASE2 ?? '0',
                NEXT_PUBLIC_ENABLE_LARAVEL_PHASE2: process.env.NEXT_PUBLIC_ENABLE_LARAVEL_PHASE2 ?? '0',
